...
test('preserves the existing global brand proof and routes to writing and speaking', () => {
  ...
  expect(screen.getByRole('link', { name: /Writing & The Blueprint/ })).toHaveAttribute('href', '/writing');
  expect(screen.getByRole('link', { name: /Speaking & keynotes/ })).toHaveAttribute('href', '/speaking');
});
