  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.archive} aria-label="More projects">
        <div className={styles.projectGrid}>{otherProjects.slice(2).map((project) => <Link key={project.id} to={pagePath(`/building/${project.id}`)} state={origin} aria-label={`Open ${project.name} project`} className={styles.project}>
