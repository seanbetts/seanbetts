  ...
  return <figure className={styles.street}>
    <div className={styles.viewport} tabIndex={0} role="region" aria-label="Illustrated brand high street" aria-describedby="street-pan-hint">
      <div className={styles.scene}>
        <img className={styles.environment} src="/images/game/brand-street/street-integrated-v4.png" alt="Illustrated high street with Sainsbury's, Chanel, Apple and Barclays shopfronts, a Channel 4 poster and a British Gas van." width="2172" height="724" loading="lazy" />
      </div>
    </div>
