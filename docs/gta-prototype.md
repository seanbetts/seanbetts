...
Thought Leadership opens with the unboxed heading “AI thought leadership for global brands.” and the original strategic-perspectives paragraph. The separate speaking-image hero, eyebrow, expertise tagline and duplicate Global Brands strip are removed. The five-image collage starts directly inside one continuous ink frame, with the high street first. Its six original SVG logos appear on four storefronts, a poster and a van. The street pans horizontally on phones, with all 21 brand names retained in a compact disclosure below the collage. The former Writing/Speaking action container is removed; those destinations remain in the global menu. Image provenance and the generation prompt are in `public/images/game/brand-street/README.md`.
